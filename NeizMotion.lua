...
createToggle(motionBlurPage, 1, "Motion Blur", "blurEnabled", "Blurs the view while the camera moves")
...
createSlider(settingsPage, 1, "Transparency", "guiTransparency", 0, 0.35, 2, applyAppearance)
...
createToggle(settingsPage, 6, "Floating Widget", "widgetVisible", nil, function(on)
    floatingWidget.Visible = on and not State.isOpen
end)
createToggle(settingsPage, 7, "Remember Position", "rememberPosition",
...
local function switchTab(name)
    ...
    tween(sidebarHighlight, { Position = toMotion and UDim2.new(0, 0, 0, 0) or UDim2.new(0, 0, 0, NAV_BTN_H + 6) }, 0.2)
    tween(motionCaption, { TextColor3 = toMotion and Palette.text or Palette.subtext }, 0.15)
    tween(settingsCaption, { TextColor3 = toMotion and Palette.subtext or Palette.text }, 0.15)
    ...
    showPage.Position = UDim2.new(toMotion and -0.06 or 0.06, 0, 0, 0)
    showPage.GroupTransparency = 1
    tween(showPage, { Position = UDim2.new(0, 0, 0, 0), GroupTransparency = 0 }, 0.2)

    tween(hidePage, { Position = UDim2.new(toMotion and 0.06 or -0.06, 0, 0, 0), GroupTransparency = 1 }, 0.16)
